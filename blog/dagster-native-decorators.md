...
Each ships a Python decorator + a `wraps:`-composable YAML component
backed by the same helper module, plus a runnable walkthrough that
reproduces both shapes in about sixty seconds:
