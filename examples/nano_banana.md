# Nano Banana — [`gemini_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/gemini_image_generation) end-to-end
...
|---|---|
| [`gemini_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/gemini_image_generation) | Native single-vendor wrapper for Google's Gemini 2.5 Flash Image. Goes directly through the `google-genai` SDK — no LiteLLM dependency. Supports text-to-image and image-to-image editing. |

## Validation status

- **[`gemini_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/gemini_image_generation): code** — `dg check defs` passes. Component
...
The registry already has [`litellm_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/litellm_image_generation) which routes to
DALL-E, Stable Diffusion, Replicate, and (via `gemini/*` model ids)
Nano Banana itself. We ship [`gemini_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/gemini_image_generation) alongside it
because:
...
- **Drop-in field shape** — `upstream_asset_key`, `prompt_column`,
  `output_path_column`, etc. match [`litellm_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/litellm_image_generation), so
  swapping is just changing the `type:` line.

| Pick [`gemini_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/gemini_image_generation) when... | Pick [`litellm_image_generation`](https://github.com/eric-thomas-dagster/dagster-component-templates/tree/main/assets/ai/litellm_image_generation) when... |
|---|---|
